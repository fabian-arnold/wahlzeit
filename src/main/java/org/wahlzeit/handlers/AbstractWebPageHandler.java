 ...
 */
public abstract class AbstractWebPageHandler extends AbstractWebPartHandler implements
    WebPageHandler {
  ...
  protected void makeWebPageFrame(UserSession us, WebPart page) {
    ...
    page.addString("footer",
        client.getLanguageConfiguration().getPageFooter(client.getPhotoSize()));
