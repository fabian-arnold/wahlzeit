 ...
 */
public abstract class AbstractWebFormHandler extends AbstractWebPartHandler implements
    WebFormHandler {
  ...
  public final String handlePost(UserSession us, Map args) {
    ...
    try {
      ...
      log.warning(
          LogBuilder.createSystemMessage().addException("Handle post failed", t).toString());
