...
public class SendEmailFormHandler extends AbstractWebFormHandler {
  ...
  protected void doMakeWebPart(UserSession us, WebPart part) {
    ...
    part.addString(USER_LANGUAGE,
        user.getLanguageConfiguration().asValueString(user.getLanguage()));
  ...
  protected String doHandlePost(UserSession us, Map args) {
    ...
    emailService.sendEmailIgnoreException(toUser.getEmailAddress(), config.getAuditEmailAddress(),
        emailSubject,
        emailBody);
