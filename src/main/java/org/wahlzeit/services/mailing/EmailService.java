...
public interface EmailService {
   ...
   *
   */
  void sendEmail(EmailAddress from, EmailAddress to, String subject, String body)
  ...
  boolean sendEmailIgnoreException(EmailAddress from, EmailAddress to, EmailAddress bcc,
