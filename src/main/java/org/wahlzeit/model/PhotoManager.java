 ...
 */
@DesignPattern(value = {PatternType.DATA_ACCESS_OBJECT,
    PatternType.SINGLETON}, participants = Photo.class)
...
public class PhotoManager extends ObjectManager {
  ...
  protected void updateTags(Photo photo) {
    ...
    for (Iterator<String> i = tags.iterator(); i.hasNext(); ) {
      ...
      log.config(
          LogBuilder.createSystemMessage().addParameter("Writing Tag", tag.asString()).toString());
      writeObject(tag);
    }
  }
