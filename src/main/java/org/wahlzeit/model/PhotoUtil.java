...
public class PhotoUtil {
   ...
   * @methodtype creation
   */
  public static Photo createPhoto(String filename, PhotoId id, Image uploadedImage)
      throws Exception {
  ...
  protected static void scaleImage(Image source, PhotoSize size, Photo photo) throws Exception {
    ...
    log.config(
        LogBuilder.createSystemMessage().addParameter("Scaled image to size", size.asString())
            .toString());
  }
